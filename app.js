...
class Juegos
{
    ...
    async function fetchJuegos(){
      ...
      fetchJuegos().then(productos => {
        ...
        juegosOption[0].nombreJuego = "Cyberpunk 2077"
        juegosOption[0].precioJuego = 24.99
    
        juegosOption[1].nombreJuego = "Assasins Creed Valhalla"
        juegosOption[1].precioJuego = 29.99
    
        juegosOption[2].nombreJuego = "God Of War 4"
        juegosOption[2].precioJuego = 9.99
    
        juegosOption[3].nombreJuego = "Bloodborne"
        juegosOption[3].precioJuego = 9.99
    
        juegosOption[4].nombreJuego = "Metro Exodus"
        juegosOption[4].precioJuego = 14.99
    
        juegosOption[5].nombreJuego = "Dead By Daylight"
        juegosOption[5].precioJuego = 29.99
    
        juegosOption[6].nombreJuego = "Left 4 Dead 2"
        juegosOption[6].precioJuego = 4.99
    
        juegosOption[7].nombreJuego = "Resident Evil 4"
        juegosOption[7].precioJuego = 9.99
    
        juegosOption[8].nombreJuego = "Amnesia The Dark Descent"
        juegosOption[8].precioJuego = 7.99
    
        juegosOption[9].nombreJuego = "The Witcher 3 Wild Hunt"
        juegosOption[9].precioJuego = 59.99
...
switch (menuJuegos.value) {
    case "Cyberpunk 2077":
        ...
        Swal.fire({
            ...
            text: 'En carrito',
            imageUrl: 'https://culturageek.com.ar/wp-content/uploads/2022/05/2077.jpg',
            imageWidth: 400,
            imageHeight: 200,
